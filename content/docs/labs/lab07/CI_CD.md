...
由于精力有限，这部分内容将**不再展开**讲解，有兴趣的同学可以自行查阅[PaperMod主题的文档](https://github.com/adityatelange/hugo-PaperMod/wiki/Features)进行配置，PaperMod主题还有一个[示例的博客网站](https://adityatelange.github.io/hugo-PaperMod/)以供参阅，实际配置起来**并不复杂**。
...
```yml
baseURL: https://ACMatrix53.github.io/myblog
languageCode: en-us
